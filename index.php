                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                ...
                                                <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['id']; ?>">
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                ...
                                                                <button type="button" class="btn-close btn-sm" data-bs-dismiss="modal" aria-label="Yakin"></button>
                                                            </div>
